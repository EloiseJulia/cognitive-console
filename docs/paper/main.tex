...
\caption{Paired steer-minus-bounded-prompt uncertainty effects and Bonferroni-corrected intervals across the four tested model–method cells. These are frozen-scorer, complete-case contrasts; the sign is not identified once all-generation missingness is admitted (see the Qwen–CAA recheck).}
