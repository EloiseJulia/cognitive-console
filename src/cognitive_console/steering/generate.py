...
class SteeredHFBackend(GenBackend):
    ...
    def _ensure_loaded(self):
        ...
        self._config = AutoConfig.from_pretrained(self.model_name, **revision_kwargs)
        self._tokenizer = AutoTokenizer.from_pretrained(self.model_name, **revision_kwargs)
        ...
        try:
            model = AutoModelForCausalLM.from_pretrained(
                self.model_name, dtype=dtype, low_cpu_mem_usage=True, **revision_kwargs
            )
        except TypeError:
            model = AutoModelForCausalLM.from_pretrained(
                self.model_name, torch_dtype=dtype, low_cpu_mem_usage=True, **revision_kwargs
            )
