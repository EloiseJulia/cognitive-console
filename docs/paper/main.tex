...
{}% FL-042
{}% C-003
The contract turns that aggregate into three structured evidence profiles: resolution near the floor for the refined skepticism cell, equivalence-within-margin for the powered deliberation cells, and a comparator-specific calibration warning for uncertainty. These profiles guide different next evaluations, rather than collapsing all twelve tests into one universal null.
...
\textbf{Deliberation preserves a mixed result.} Two ITI cells fell inside a \(\pm0.05\) equivalence interval in a post-hoc TOST, and a pre-registered refinement now powers both CAA cells to the same conclusion (Qwen mean \(+0.021\), 90\% TOST CI \([0.005,0.040]\), \(N=150\), MDE \(0.039\); Llama mean \(+0.007\), CI \([-0.004,0.016]\), \(N=150\), MDE \(0.036\)): CAA steering is equivalent to the best prompt within \(\pm0.05\) on deliberation, no longer merely underpowered. {}% FL-005
{}% FL-014
{}% FL-043
...
Deliberation & TRANSFER no-pass; small mixed differences, exploratory post-hoc equivalence in two ITI cells, and a pre-registered refinement powering both CAA cells & Both CAA cells now powered to \(\pm0.05\) equivalence; ITI cells were already equivalent. \\
...
The three evidence profiles lead to different evaluation work. Where refined, skepticism is bounded-equivalent and deliberation is equivalent to the best prompt within the margin; uncertainty calls for measurement repair and a comparator-specific warning. {}% FL-041
{}% FL-043
{}% FL-047
...
{}% FL-038
A pre-registered refinement powers the Qwen--CAA deliberation and skepticism cells to \(\pm0.05\) equivalence (skepticism bounded, at MDE 0.053 slightly above the floor), and uncertainty remains format- and missingness-sensitive. {}% FL-041
{}% FL-043
{}% FL-047
{}% FL-048
