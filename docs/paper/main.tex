...
{}% FL-031
The record therefore reports a resolution need near the floor, not an ineffectiveness verdict.
...
\caption{Artifact-derived cards show computational status, the axis-specific blocking reason, the evidence tier, and the record-specific interface action; each card also surfaces any missing provenance link (here, the persisted direction/split identity) as part of the tier rather than concealing it.}
