...
None of the twelve model--method--axis tests qualifies under the reported rule---the contract doing its job: no candidate earned an active control, so each is withheld rather than promoted on legibility or output movement alone. That common computational result does not imply one common scientific conclusion or interface action. Skepticism is underpowered near the point-estimate floor; deliberation is mixed; and uncertainty is negative relative to the comparator under the frozen scorer, with a targeted Qwen--CAA recheck whose complete-case estimate remains negative but whose all-generation missingness bounds cross zero. {}% FL-003
{}% FL-004
{}% FL-041
{}% FL-043
{}% FL-047
...
\midrule
Skepticism & TRANSFER no-pass; MDEs far exceed the 0.05 point-estimate floor & Resolution near the floor obtained for the Qwen--CAA cell (bounded-equivalent within \(\pm0.05\) at MDE 0.053); the other three cells, ITI, and a passing latent positive control remain open. \\
