...
## 2026-08-20 · D-0140 · Fold-gate ITI deliberation 512-token re-measurement (additive, Table 2 symmetry)
- **Owner-requested escalation (2026-08-20):** close the Table 2 (tab:c2-delta-4cell) asymmetry — CAA deliberation cells were re-measured at 512 (E-DELIB512-REMEASURE) but ITI cells were not. This additive ITI×{Qwen,Llama} deliberation-512 mirrors the CAA protocol.
- **Evidence:** `iti-delib-512-test-20260820` on `feature/iti-delib512@7362689` (frozen prereg `fc76732`; results `22fa0b5`; seal-rehash fix `7362689`). 512-DEV α reselected (α=2.0 both), steer-vs-best-prompt substitution estimand, coherence gate, DEV/TEST zero overlap.
- **Results (independently re-derived by audit, bit-match):** I1 Qwen ITI Δ=−0.0333 CI[−0.0787,+0.0093] TOST[−0.064,−0.004] **UNDERPOWERED (small negative)**; I2 Llama ITI Δ=+0.0053 CI[−0.0427,+0.0533] TOST[−0.028,+0.039] **EQUIVALENT (near-zero)**. 512 off floor (I1 acc 0.84/0.87/0.84; I2 0.71/0.71/0.76); truncation 0; coherence pass.
- **Independent hostile audit:** `audit-iti-delib512` = numbers SOUND; the one lineage BLOCKER (SEALED.json hash ≠ committed result, caused by post-seal reporting-diagnostic augmentation, scientific arrays unchanged) was CLOSED by rehash (`iti-delib512-seal-rehash`); Manager verified seal==committed (I1 e1e1cf, I2 7a9120). Report `reviews/2026-08-20-iti-delib512-audit/audit-report.md`.
- **Scope (binding):** additive completion of the ITI deliberation cells of Table 2, mirroring CAA E-DELIB512-REMEASURE. Report I1 as small-negative UNDERPOWERED and I2 as near-zero EQUIVALENT (honest sign+power, no spin, not a headline). Does NOT revise the frozen 0/12 grid, E-0005/E-0006/E-0011, or the CAA delib512 record.
- **Bookkeeping:** D-0140 chosen safe-high to avoid collision with main's own D-0135/D-0136 and other branches' D-0137; merge-time renumber tracked.
- **Frozen?** valid_for_paper=true for the narrow additive scope; TEST-once, no re-selection.
