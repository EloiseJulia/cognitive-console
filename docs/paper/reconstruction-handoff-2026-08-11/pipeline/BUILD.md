...
- Final clean build on 2026-08-11: 17 pages, 5 labeled equations, 1 TikZ flow figure, 5 evidence tables, 3 generated PDF figures (READ, calibration, and console), and 2 substantive appendices; no undefined references, overfull boxes, or substantive LaTeX warnings.
...
- Validation attribution for the C3 direct-mapping repair: `python -m pytest -q --ignore=tests/test_microstudy_web.py` passes. The excluded browser timeout predates and is unrelated to this paper/console change; no browser code was modified.
