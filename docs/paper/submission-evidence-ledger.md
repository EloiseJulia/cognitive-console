...
| E-0009 | Exploratory PSR-style method-strength context | `results/psr_qwen_primary/` | Qwen-only, single-seed exploratory context; supplies no headline support. |
| E-0011 | Five split-seed robustness companion | `results/E-0011/` | Four prospectively frozen new split seeds plus the previously observed frozen seed; same shared item pool, split sensitivity only. |
