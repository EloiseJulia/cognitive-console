...
def main() -> None:
    ...
    lines.append(r"  \caption{Frozen prompt-vs-latent behavioral adjudication across CAA/ITI $\times$ Qwen/Llama. The table supports Claim C2 and is generated from experiment artifacts E-0006 (with CAA$\times$Qwen reproducing E-0005). $\Delta$ is TEST paired steer--prompt outcome; intervals are Bonferroni two-sided CIs at level " + f"{ci_level:.5f}" + r"; the pre-registered meaningful margin is $\delta=" + f"{delta:.2f}" + r"$.}")
